package com.yrw.im.rest.repository.config;
 ...
 */
@Configuration
@MapperScan(value = "com.yrw.im.rest.repository.mapper")
@ComponentScan(basePackages = "com.yrw.im.rest.repository.service")
